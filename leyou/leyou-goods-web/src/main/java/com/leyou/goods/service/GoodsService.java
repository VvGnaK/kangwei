...
public class GoodsService {
    ...
    public Map<String,Object> loadDate (Long spuId) {
        ...
        //查询sku集合
        List<Sku> skus = goodsClient.querySkuById(spuId);
        //查询分类
        ...
        //查询规格参数
        List<SpecGroup> groups = specificationClient.queryGroupWithParam(spu.getCid3());

        //查询特殊的规格参数
        List<SpecParam> paramList = specificationClient.queryParams(null, spu.getCid3(), false, null);
